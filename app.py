...
class MewCodeApp(App):
    ...
    def __init__(
        ...
        self.trajectory_manager: Any | None = None
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        from mewcode.evolution.trajectory.manager import TrajectoryManager
        if self.hook_engine is None:
            self.hook_engine = HookEngine([])
        self.trajectory_manager = TrajectoryManager(work_dir)
        self.hook_engine.add_listener(self.trajectory_manager)
    ...
    def _set_session(self, session: Session) -> None:
        ...
        if self.trajectory_manager and hasattr(self.trajectory_manager, "set_session_id"):
            self.trajectory_manager.set_session_id(session.session_id)
